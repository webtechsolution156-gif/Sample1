            ...
            <div key={product.id} className="bg-white rounded-xl shadow-md overflow-hidden group">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {product.inStock ? <span className="text-xs text-green-600">In Stock</span> : <span className="text-xs text-red-600">Out of Stock</span>}
                </div>
                <button
                  onClick={() => {
                    addToCart(product);
                  ...
                  className={`w-full py-2 rounded-lg text-sm transition ${
                    product.inStock ? 'bg-primary text-white hover:bg-blue-700' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  }`}
                >
